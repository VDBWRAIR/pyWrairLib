...
from wrairlib.fff.runfiletitanium import RunFile
from wrairlib.util import get_all_

# Where is newbler installed
newbler_install_path = '/home/EIDRUdata/programs/vdbapps/bin/'
        ...
        for sample in rf.samples:
            if not sample.disabled and sample.refgenomelocation:
                ...
                try:
                    ...
                    continue
                jobops = {'projectdir':project_directory, 'cpu': 1, 'bam': True}
